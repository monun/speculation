...
class GameDialogMagic(val magics: List<Magic>) : GameDialog<Magic>()
class GameDialogTargetPiece(val candidates: List<Piece>) : GameDialog<Piece>()
class GameDialogTargetZone(val candidates: List<Zone>) : GameDialog<Zone>()
